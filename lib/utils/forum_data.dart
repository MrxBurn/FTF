List threads = [
    ...
    'links': [
      {
        ...
        'url': 'https://www.youtube.com/watch?v=C4tv93E4xr0'
      },
      {
        'name': 'Representing the MMA community',
    ...
    'links': [
      {
        ...
        'url': 'https://www.youtube.com/watch?v=JgZSFkPrk24'
      },
      {
        'name': 'How Nutrition Can Improve Your Performance',
        'url':
            'https://www.myprotein.com/thezone/nutrition/combat-sports-nutrition/'
      },
      {
        'name': 'How to Fuel Your Training',
  ...
  {
    'collection': 'sparring',
    'title': ' Finding Quality Sparring Partners',
